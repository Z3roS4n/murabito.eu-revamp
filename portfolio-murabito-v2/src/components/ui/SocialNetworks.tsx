  ...
  const socials: Array<SocialObject> = [
    {
      ...
      icon: <FontAwesomeIcon className="text-black w-10" icon={faInstagram} />
    },
    {
      type: 'instagram',
      name: 'msworks.arw',
  ...
  return (
    <div className="flex flex-col not-lg:flex-row gap-4">
        { socials.map((social, index) =>
          <div key={index} className="text-black glass p-2 shadow-md hover:shadow-gray-500 hover-trans-long">
